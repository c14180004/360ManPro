    ...
    <body id="page-top">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Welcome to Petra University Virtual Tour!</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Enjoy our free virtual tour around our prestigious christian university! Don't forget to use it in moderation.</p>
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about" style="color: #fff; background-color: #f4623a;">Find Out More</a>
                    </div>
                </div>
            </div>
        </header>
        <!-- About-->
        <section class="page-section" id="about" style="background-color:rgb(51,51,51)">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                            <p class="text-white-50 mb-4 justify-content-center text-justify" style="color: rgba(255, 255, 255, 0.5) !important;">
                            Universitas Kristen Petra (sering disingkat UK Petra atau UKP) adalah sebuah perguruan tinggi swasta nasional 
                            di Surabaya, Jawa Timur, Indonesia. Universitas ini didirikan pada tahun 1961 atas prakarsa dari 
                            beberapa pendiri PPPK Petra, sebuah yayasan pendidikan Kristen di Surabaya yang telah didirikan 
                            pada tahun 1951. Nama "Petra" berasal dari bahasa Yunani yang berarti "Batu Karang".</p>
                            </div>
                            <div class="col-md-6 justify-content-center">
                                <img src="assets/droneviewq.jpg" class="img-fluid">
                            </div>
                        </div>
        ...
        <section class="page-section bg-dark text-white">
            <div class="container text-center">
                <h2 class="mb-4">Let's get the Virtual Tour Started!</h2>
                <a class="btn btn-light btn-xl  js-scroll-trigger" href="360view.php" style="color: #212529; background-color: #f8f9fa;">
                Start Now!</a>
            </div>
        </section>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <h2 class="text-center mt-0">List Gedung</h2>
                <hr class="divider my-4" />
            </div>
        </section>
        <!-- Portfolio-->
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="360view.php?gedung=Gedung%20W">
                            ...
                            <div class="portfolio-box-caption">
                                ...
                                <div class="project-name">Gedung W</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="360view.php?gedung=Gedung%20P">
                            ...
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Building Name</div>
                                <div class="project-name">Gedung P</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/q.jpg">
                            ...
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Building Name</div>
                                <div class="project-name">Gedung Q</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/t.jpg">
                            ...
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Building Name</div>
                                <div class="project-name">Gedung T</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/library.jpg">
                            ...
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Building Name</div>
                                <div class="project-name">Library</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
